      ...
      return (
        <div className="flex flex-col items-center justify-center h-full text-gray-500">
          <div className="mt-36">
            ...
            {debouncedSearchTerm && (
              <p className="mt-2">
                Không có kết quả cho tìm kiếm &ldquo;{debouncedSearchTerm}
                &ldquo;. Vui lòng thử lại với từ khóa khác.
              </p>
            )}
          </div>
        </div>
    ...
    <div className="container mx-auto p-4">
      <div className="flex justify-between mb-8">
        <div className="relative">
          <input
            type="text"
            placeholder="Tìm kiếm món ăn vặt..."
        ...
        >
          <Plus size={20} className="mr-2" /> Thêm món ăn vặt mới
        </button>
      </div>
      ...
      {isAddProductModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white p-2 rounded-lg w-full max-w-md h-[90vh] flex flex-col">
            <div className="sticky top-0 bg-white z-10 px-4 py-3 border-b">
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-bold">Thêm món ăn vặt mới</h2>
                <button
            ...
            <form
              ...
              className="flex-1 p-4 overflow-y-auto scrollbar-none space-y-4"
            >
              <div>
                ...
                <input
                  ...
                  placeholder="Nhập tên món ăn vặt"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                >
                  ...
                  <option value="Đồ ăn vặt mặn">Đồ ăn vặt mặn</option>
                  <option value="Đồ ăn vặt ngọt">Đồ ăn vặt ngọt</option>
                  <option value="Đồ ăn vặt healthy">Đồ ăn vặt healthy</option>
                  <option value="Đồ ăn vặt nước ngoài">
                    Đồ ăn vặt nước ngoài
                  </option>
                  <option value="Đồ uống & thạch rau câu">
                ...
                <div className="flex-1 p-4 overflow-y-auto scrollbar-none space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <option value="Đồ ăn vặt mặn">Đồ ăn vặt mặn</option>
                      <option value="Đồ ăn vặt ngọt">Đồ ăn vặt ngọt</option>
                      <option value="Đồ ăn vặt healthy">
                        Đồ ăn vặt healthy
                      </option>
                      <option value="Đồ ăn vặt nước ngoài">
                        Đồ ăn vặt nước ngoài
